...
static const char password[128] = "7932#";
static uint16_t step = 0;
static uint16_t last_step = strlen(password);
/* USER CODE END PV */
...
int main(void)
{
	...
	while (1)
	{
		...
		if ( (HAL_GetTick() > tick + PASSWORD_TIMEOUT) && (step != 0)) {
			step = 0;
